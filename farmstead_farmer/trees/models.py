...
class Tree(models.Model):
    ...
    family = models.CharField(max_length=50, verbose_name="Родина", null=True, blank=True)
...
class Sort(models.Model):
    ...
    usage = models.CharField(max_length=45, verbose_name="Використання", null=True, blank=True)
...
class Cutting(models.Model):
    idCutting = models.AutoField(primary_key=True)
    ...
    def __str__(self):
        return f"{self.tree.name} - Cutting"


class Disease(models.Model):
    idDiseases = models.AutoField(primary_key=True)
    ...
    def __str__(self):
        return f"{self.tree.name} - {self.disease_name}"
...
class Fertilizer(models.Model):
    ...
    def __str__(self):
        return f"{self.tree.name} - Fertilizer {self.fertilizer}"
...
class Planting(models.Model):
    ...
    def __str__(self):
        return f"{self.tree.name} - Planting"
